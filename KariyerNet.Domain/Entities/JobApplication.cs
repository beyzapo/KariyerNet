...
namespace KariyerNet.Domain.Entities
{
    ...
    public class JobApplication
    {
        ...
        public User Candidate { get; set; } //navigation property to the User entity (candidate)

        public Guid JobPostingId { get; set; } //whose job posting is this application for 
        public JobPosting JobPosting { get; set; } //navigation property to the JobPosting entity
